...
* Multi-dimensional or Pixel RNN [[Paper](http://arxiv.org/pdf/0705.2011.pdf)]  [[code](https://github.com/pybrain/pybrain/blob/master/pybrain/structure/networks/multidimensional.py)] 
* PixelCNN [[Paper](https://arxiv.org/pdf/1601.06759.pdf)] [[Tensorflow](https://github.com/tensorflow/magenta/blob/master/magenta/reviews/pixelrnn.md)] [[Keras](https://github.com/kundan2510/pixelCNN)] [[Torch](https://github.com/dritchie/pixelCNN)]  
* Conditional PixelCNN [[Paper](https://arxiv.org/abs/1606.05328)] [[Tensorflow](https://github.com/anantzoid/Conditional-PixelCNN-decoder)] 
* PixelCNN++ [[Paper](https://openreview.net/pdf?id=BJrFC6ceg)] [[TensorFlow](https://github.com/openai/pixel-cnn)] [[Faster Tensorflow](https://github.com/PrajitR/fast-pixel-cnn)]
